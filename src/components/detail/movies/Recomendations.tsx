import { getRecomendations } from "@/api/movies/detail";
...
export default async function Recomendations({ idMovie }: { idMovie: string }) {
  const dataRecomendations = await getRecomendations(Number(idMovie));
